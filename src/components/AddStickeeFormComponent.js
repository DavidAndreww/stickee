...
const AddStickeeFormComponent = (props) => {
  return (
    <div>
      <button
        onClick={props.toggleAddStickeeForm}
        className='toggle-dialog-btn'
      >
        +
      </button>
      <Dialog
        open={props.stickeeFormOpen}
        className='add-stickee-dialog-component'
      >
        ...
        <button
          className='stickee-form-back-btn'
          onClick={() => props.toggleAddStickeeForm(true)}
        >
          Back
        </button>
      </Dialog>
